...
const PaginoidItem = ({ page, isActive, itemsClassName, activeClassName, handleClick }) => {
    ...
    return (React__default['default'].createElement("div", { tabIndex: 0, role: 'button', className: cx$2([itemsClassName, 'paginoid_item', 'paginoid_clickable']), onKeyDown: handleKeyDown, onClick: () => handleClick(page.value) },
        React__default['default'].createElement("span", { className: cx$2({
...
const PaginoidArrow = ({ handleClick, arrowTitle, arrowsClassName, disabledArrowClassName, isActive = false }) => {
    ...
    return (React__default['default'].createElement("div", { tabIndex: 0, role: 'button', "data-type": 'back', className: cx$1({
            paginoid_arrow: true,
...
function Paginoid({ total, perPage, currentPage, handleChange, prevButtonTitle = 'Left', nextButtonTitle = 'Right', containerClassName, arrowsClassName, itemsClassName, activeItemClassName, disabledArrowClassName }) {
    ...
    React.useEffect(() => setPagesCount(Math.ceil(total / perPage)), []);
    return (React__default['default'].createElement(React__default['default'].Fragment, null, pages.length ? (React__default['default'].createElement("div", { className: cx(['paginoid', containerClassName]) },
        ...
        React__default['default'].createElement("ul", { className: cx('paginoid_list') }, pages.map((item) => (React__default['default'].createElement("li", { key: item.value },
